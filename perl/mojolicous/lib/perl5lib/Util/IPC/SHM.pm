...
=head1 NAME
  ...
  Util::IPC::SHM  - a simple wrapper for shmget shmwrite shmread
...
=head1 SYNOPSIS
  ...
  my $shm1 = Util::IPC::SHM->new(99990000,1024);
  my $shm2 = Util::IPC::SHM->attach(99990000);
