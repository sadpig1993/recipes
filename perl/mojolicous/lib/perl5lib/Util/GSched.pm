package Util::GSched;
###############################################################
# 基于DAG的任务调度(Directed-Acyclic-Graph-Based Scheduling)
###############################################################
use strict;
use warnings;
...
# 初始化资源:
# logger
# greader:  graph reader
# gwriter:  graph writer
# running:  当前运行子进程个数置为0  
###############################################
sub on_start {
...
=head1 NAME
  ...
  Util::GSched  - a simple mailmox implementation
